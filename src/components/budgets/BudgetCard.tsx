...
const BudgetCard = ({category, theme, max_amount, id} : Budget) => {
    ...
    const moneySpentPercentage = moneySpent*100/max_amount
    const remaining = max_amount - moneySpent
  ...
  return (
    <Card $gap={'20px'}>
        ...
        <p>Maximum of ${max_amount.toFixed(2)}</p>
